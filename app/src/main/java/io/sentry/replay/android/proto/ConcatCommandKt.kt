...
public inline fun concatCommand(block: io.sentry.replay.android.proto.ConcatCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand =
    io.sentry.replay.android.proto.ConcatCommandKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand.newBuilder())
        .apply { block() }._build()
...
public object ConcatCommandKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            ...
            @kotlin.PublishedApi
            internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand.Builder): Dsl =
                Dsl(builder)
        }

        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand =
            _builder.build()
...
public inline fun io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand.copy(block: io.sentry.replay.android.proto.ConcatCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.ConcatCommand =
    io.sentry.replay.android.proto.ConcatCommandKt.Dsl._create(this.toBuilder()).apply { block() }
        ._build()
