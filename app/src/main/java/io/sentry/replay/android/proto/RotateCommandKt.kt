...
public inline fun rotateCommand(block: io.sentry.replay.android.proto.RotateCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand =
    io.sentry.replay.android.proto.RotateCommandKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand.newBuilder())
        .apply { block() }._build()
...
public object RotateCommandKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            ...
            @kotlin.PublishedApi
            internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand.Builder): Dsl =
                Dsl(builder)
        }

        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand =
            _builder.build()
...
public inline fun io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand.copy(block: io.sentry.replay.android.proto.RotateCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.RotateCommand =
    io.sentry.replay.android.proto.RotateCommandKt.Dsl._create(this.toBuilder()).apply { block() }
        ._build()
