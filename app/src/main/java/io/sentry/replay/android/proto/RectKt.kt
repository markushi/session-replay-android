...
public inline fun rect(block: io.sentry.replay.android.proto.RectKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.Rect =
  io.sentry.replay.android.proto.RectKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.Rect.newBuilder()).apply { block() }._build()
/**
...
public object RectKt {
  ...
  public class Dsl private constructor(
    ...
    public companion object {
      ...
      @kotlin.PublishedApi
      internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.Rect.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.Rect = _builder.build()
