...
public inline fun drawRectCommand(block: io.sentry.replay.android.proto.DrawRectCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand =
    io.sentry.replay.android.proto.DrawRectCommandKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand.newBuilder())
        .apply { block() }._build()
...
public object DrawRectCommandKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            ...
            @kotlin.PublishedApi
            internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand.Builder): Dsl =
                Dsl(builder)
        }

        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand =
            _builder.build()
...
public inline fun io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand.copy(block: io.sentry.replay.android.proto.DrawRectCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.DrawRectCommand =
    io.sentry.replay.android.proto.DrawRectCommandKt.Dsl._create(this.toBuilder()).apply { block() }
        ._build()
