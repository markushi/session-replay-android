...
public inline fun clipRectFCommand(block: io.sentry.replay.android.proto.ClipRectFCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand =
    io.sentry.replay.android.proto.ClipRectFCommandKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand.newBuilder())
        .apply { block() }._build()
...
public object ClipRectFCommandKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            ...
            @kotlin.PublishedApi
            internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand.Builder): Dsl =
                Dsl(builder)
        }

        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand =
            _builder.build()
...
public inline fun io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand.copy(block: io.sentry.replay.android.proto.ClipRectFCommandKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.ClipRectFCommand =
    io.sentry.replay.android.proto.ClipRectFCommandKt.Dsl._create(this.toBuilder())
        .apply { block() }._build()
