...
public inline fun paint(block: io.sentry.replay.android.proto.PaintKt.Dsl.() -> kotlin.Unit): io.sentry.replay.android.proto.ReplayOuterClass.Paint =
    io.sentry.replay.android.proto.PaintKt.Dsl._create(io.sentry.replay.android.proto.ReplayOuterClass.Paint.newBuilder())
        .apply { block() }._build()
...
public object PaintKt {
    ...
    public class Dsl private constructor(
        ...
        public companion object {
            ...
            @kotlin.PublishedApi
            internal fun _create(builder: io.sentry.replay.android.proto.ReplayOuterClass.Paint.Builder): Dsl =
                Dsl(builder)
        }

        @kotlin.jvm.JvmSynthetic
        @kotlin.PublishedApi
        internal fun _build(): io.sentry.replay.android.proto.ReplayOuterClass.Paint =
            _builder.build()
